      ...
      <aside className="hidden md:flex w-64 bg-white border-r border-gray-200 flex-col h-screen sticky top-0">
        <div className="p-6 border-b">
          <div className="flex items-center gap-2">
            <LayoutDashboard className="text-primary-600 w-6 h-6" />
            ...
            {users?.length > 0 ? (
              <ul className="space-y-2">
                {users.map((u) => (
                  <li
                    key={u.id}
                    className="border p-2 rounded-md flex flex-col sm:flex-row sm:justify-between"
                  >
              ...
              {categories?.length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {categories.map((cat) => (
                    <div
                      key={cat.id}
                      className="border p-4 rounded-lg bg-gray-50 flex flex-col justify-between"
                    >
                      <div>
