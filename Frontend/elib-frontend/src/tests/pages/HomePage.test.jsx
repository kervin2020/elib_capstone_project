...
jest.mock('../../contexts/BookContext', () => ({
  useBooks: () => mockBookContext
}));

jest.mock('../../contexts/LoanContext', () => ({
  useLoans: () => mockLoanContext
}));
...
describe('HomePage Component', () => {
  ...
  test('renders hero section', () => {
    ...
    expect(screen.getByText('Welcome to E-Lib')).toBeInTheDocument();
    expect(screen.getByText('Read online or loan physical books easily.')).toBeInTheDocument();
  });
  ...
  test('renders search bar', () => {
    ...
    expect(screen.getByPlaceholderText('Search in site...')).toBeInTheDocument();
  });
  ...
  test('renders books section', () => {
    ...
    expect(screen.getByText('List of all E-books and physical books in the library.')).toBeInTheDocument();
  });
  ...
  test('renders recommended reads section', () => {
    ...
    expect(screen.getByText('Recommended Reads')).toBeInTheDocument();
    expect(screen.getByText('Handpicked books just for you.')).toBeInTheDocument();
  });
  ...
  test('renders user reviews section', () => {
    ...
    expect(screen.getByText('What our readers say about us.')).toBeInTheDocument();
  ...
  test('renders loading state when books are loading', () => {
    ...
    // Vérifier que fetchBooks est appelé
    expect(mockBookContext.fetchBooks).toHaveBeenCalled();
  });
  ...
  test('renders book availability status', () => {
    ...
    // Vérifier que les statuts de disponibilité sont affichés
  ...
  test('renders monthly loans chart', () => {
    ...
    expect(screen.getByText('Monthly Loans')).toBeInTheDocument();
  ...
  test('renders footer with contact information', () => {
    ...
    expect(screen.getByText('E-Lib')).toBeInTheDocument();
